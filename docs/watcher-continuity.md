...
`state/.watch-triage.log` remains only the watcher's own bounded observational debug log, written for absorbed wakes and other non-actionable watcher notes, and carries no lifecycle semantics.
