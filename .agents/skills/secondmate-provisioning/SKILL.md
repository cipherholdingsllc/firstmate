...
You resolve each project's origin yourself - from the captain, the project registry, a clone that exists elsewhere, native `gh`, or an explicit paste - and name it as `<project>=<origin-url>`; the seed validates and transports what you supply.
